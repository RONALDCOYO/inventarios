...
urlpatterns = [
    ...
    path('crear_abono/<int:id>/', views.crear_abono, name='crear_abono'),
    path('factura/<int:factura_id>/crear_abono/', views.crear_abono, name='crear_abono_factura'),  # Ajustamos esta línea
